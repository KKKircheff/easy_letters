...
const Projects = ({ control }: Props) => {
    ...
    return (
        <Box>
            <ProfileSectionTitle title='Personal projects' subtitle='Optional section. Add personal projects you consider important for your job applications.' />
            <Stack maxWidth='1200px' spacing={1.5} textAlign='left' alignItems={'center'} px={.75} mx='auto'>
                ...
                <Box
                    ...
                    <AddNew
                        itemToAdd={'personal project ( optional )'}
                        description={'Business projects, startups or freelance projects.'}
                    />
                </Box>
            </Stack>
